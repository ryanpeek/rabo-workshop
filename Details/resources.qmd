...
format:
  html:
    ...
    toc-location: right
    df-print: paged
bibliography: ../data/rabo_references.bib
editor_options: 
...
{{< downloadthis ../data/rabo_references.bib dname="rabo_bibliography" label="Download .bib" icon="database-fill-down" type="info" >}}
