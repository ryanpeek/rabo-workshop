...
format:
  html:
    ...
    toc-location: right
    df-print: paged
bibliography: ../data/rabo_references_2026.bib
editor_options: 
...
{{< downloadthis ../data/rabo_references_2026.bib dname="rabo_bibliography" label="Download .bib" icon="database-fill-down" type="info" >}}
