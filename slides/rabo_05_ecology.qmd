...
## Dams change algal community {.smaller}

Rock Snot -- *Didymosphenia*

(*Paula Furey, Amy Lind*)
...
## Periphyton {.smaller data-menu-title="Periphyton collection" background-image="../img/sk_image44.jpg" background-size="60%" background-position="right"}
...
Raised tadpoles in growth chambers where we controlled the temperature
...
## Periphyton {.smaller data-menu-title="Periphyton collection in regulated rivers" background-image="../img/sk_image43.jpg" background-size="60%" background-position="right"}
...
## Periphyton {.smaller data-menu-title="Periphyton results" background-image="../img/sk_image45.png" background-size="contain" background-position="right"}
...
## [Flow velocity]{.blue} changes [Tadpole]{.dark-green} behavior and predation risk {.smaller background-color="#FFFFFF"}
...
## Critical <br />Velocity {.tr .smaller background-image="../img/sk_image47.png" background-size="73%" background-position="left"}
...
## {.smaller background-image="../img/sk_image87.jpg" background-size="90%" background-position="top"}
